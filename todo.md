1) div class edotor-form -> dialog class editor form & dialog mobile modal too
2) improve json object templates across the board
    2.1) minor god selection logic + de/population of temple units and techs
    2.2) [buildings grid fix](https://github.com/asavschaeffer/AoM-civ_builder/issues/1)
    2.3) add basegame civs
